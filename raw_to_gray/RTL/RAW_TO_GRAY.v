...
/* Stream 8-bit gray RAW from ROM into 24 bpp BMP with vertical flip.
 * ROM_ren/ROM_addr combinationally during FETCH (same pattern as LOAD_RAW). */
...
module RAW_TO_GRAY(
    ...
    reg [31:0] p_c, bmp_lin_c, bmp_row_c, bmp_col_c, raw_row_c, raw_lin_c;
    ...
    always @(*) begin
        ...
        rom_word_c = raw_lin_c[`ROM_ADDR_WIDTH+1:2];
    end
