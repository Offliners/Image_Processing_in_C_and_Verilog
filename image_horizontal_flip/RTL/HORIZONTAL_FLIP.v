...
// Stream header and pixels; mirror each row in X. No full-frame buffers (output uses remapped addr).
...
wire [31:0] x_m = `BMP_WIDTH - 32'd1 - x;
wire [31:0] out_pi = y * `BMP_WIDTH + x_m;
