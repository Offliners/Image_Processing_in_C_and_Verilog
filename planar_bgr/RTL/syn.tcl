#======================================================
# Synthesis: PLANAR_MERGE_TO_BMP (planar SRAM -> interleaved BMP body writer).
# Full planar flow (load + TB) is simulation-only.
#======================================================
set search_path {	./								 \
...
set DESIGN "PLANAR_MERGE_TO_BMP"
set CYCLE 20.0
...
set_input_delay 0 -clock clk merge_start
set_input_delay 0 -clock clk in_b
set_input_delay 0 -clock clk in_g
set_input_delay 0 -clock clk in_r
